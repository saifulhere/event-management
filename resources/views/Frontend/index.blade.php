...
@section('frontend')
 <!-- Hero Section Begin -->
 <section class="hero-section set-bg" data-setbg="{{asset('frontend_assets/img/hero.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div class="hero-text">
                    ...
                    <a href="{{route('admin.login')}}" class="primary-btn">Join Event</a>
                </div>
            </div>
            <div class="col-lg-5">
                <img src="{{asset('frontend_assets/img/hero-right.png')}}" alt="">
            </div>
        </div>
    </div>
</section>
