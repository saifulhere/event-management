...
<!-- Mirrored from preview.keenthemes.com/metronic/demo1/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Mar 2021 08:32:46 GMT -->
...
<head>
		...
		<link href="{{asset('dist/assets/plugins/global/plugins.bundle62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('dist/assets/plugins/custom/prismjs/prismjs.bundle62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('dist/assets/css/style.bundle62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href="{{asset('/dist/assets/css/themes/layout/header/base/light62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('/dist/assets/css/themes/layout/header/menu/light62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('/dist/assets/css/themes/layout/brand/dark62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('/dist/assets/css/themes/layout/aside/dark62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="topbar">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<!--begin:Header-->
										<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(dist/assets/media/misc/bg-1.jpg)">
								...
								<div class="dropdown">
									...
									<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
											<img class="h-20px w-20px rounded-sm" src="{{asset('dist/assets/media/svg/flags/226-united-states.svg')}}" alt="" />
										</div>
									</div>
									<!--end::Toggle-->
									<!--begin::Dropdown-->
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
										...
										<ul class="navi navi-hover py-4">
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{asset('dist/assets/media/svg/flags/226-united-states.svg')}}" alt="" />
													</span>
											...
											<li class="navi-item active">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{asset('dist/assets/media/svg/flags/128-spain.svg')}}" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{asset('dist/assets/media/svg/flags/162-germany.svg')}}" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{asset('dist/assets/media/svg/flags/063-japan.svg')}}" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{asset('dist/assets/media/svg/flags/195-france.svg')}}" alt="" />
													</span>
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						...
						<div class="overlay-layer">
							...
							<a href="../rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo2/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo2/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo3/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo3/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo4/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo4/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo5/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo5/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo6/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo6/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo7/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo7/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo8/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo8/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo9/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo9/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo10/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo10/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo11/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo11/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo12/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo12/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo13/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo13/rtl/demo1/index.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
		...
		<script src="{{asset('/dist/assets/plugins/global/plugins.bundle62fd.js?v=7.2.3')}}"></script>
		<script src="{{asset('/dist/assets/plugins/custom/prismjs/prismjs.bundle62fd.js?v=7.2.3')}}"></script>
		<script src="{{asset('/dist/assets/js/scripts.bundle62fd.js?v=7.2.3')}}"></script>
		<!--end::Global Theme Bundle-->
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo1/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Mar 2021 08:32:47 GMT -->
</html>