        ...
        <div class="col-12">
            ...
            <form class="file-upload">
                        ...
                        <div class="bg-secondary-soft px-4 py-5 rounded">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="name" value="{{$user->name}}" aria-label="First name" value="Scaralet">
                                </div>
                                <!-- Last name -->
                                <div class="col-md-6">
                                    <label class="form-label">Your username</label>
                                    <input type="text" class="form-control" placeholder="" name="username" value="@if(isset($user->username) && !$user->username === null){{$user->username}} @else {{ 'username' }} @endif " aria-label="Last name" value="Doe">
                                </div>
                                <!-- Phone number -->
                                <div class="col-md-6">
                ...
                <div class="gap-3 d-md-flex justify-content-md-end text-center">
                    <button type="button" class="btn btn-danger btn-lg mr-4">Delete profile</button>
