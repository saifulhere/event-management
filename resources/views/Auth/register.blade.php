                                ...
                                <form action="{{route('admin.store')}}" method="POST">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="text" id="form2Example11" name="name" value="{{old('name')}}" class="form-control" placeholder="Your name" />
                                            @error('name')
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="form-outline">
                                            <input type="hidden" id="form2Example11" name="status" value="active" class="form-control" placeholder="Phone number or email address" />
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="name">Email</label>
                                            <input type="email" id="form2Example11" name="email" value="{{old('email')}}" class="form-control" placeholder="example@mail.com" />
                                            @error('email')
                                            <div class="text-danger">
                                                {{$message}}
                                            </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="text" id="form2Example11" name="phone" value="{{old('phone')}}" class="form-control" placeholder="Enter phone" />
                                            @error('phone')
                                            <div class="text-danger">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="password" id="form2Example11" name="password" class="form-control" placeholder="Enter Password" />
                                            @error('password')
                                            <div class="text-danger">
                                                {{$message}}
                                            </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="password" id="form2Example11" name="password_confirmation" class="form-control" placeholder="Repeat Password" />
